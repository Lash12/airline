...
const PALETTES = {
    dark: {
        ...
        boundary: '#5b6270',
        boundaryOpacity: 0.3,
        regionBoundary: '#4a5568',
        regionBoundaryOpacity: 0.25,
        runwayGlow: '#ffffff',
        runway: '#cccccc',
        taxiway: '#888888',
        roads: '#404040',
    ...
    light: {
        ...
        boundary: '#7890a8',
        boundaryOpacity: 0.7,
        regionBoundary: '#6080a0',
        regionBoundaryOpacity: 0.4,
        runwayGlow: '#ffffff',
        runway: '#4c545e',
        taxiway: '#6f7b89',
        roads: '#97a2ac',
...
function createLayers(c) {
    return [
        ...
        { id: 'landuse-aerodrome', type: 'fill', source: 'protomaps', 'source-layer': 'landuse', minzoom: 6,
        ...
        { id: 'landuse-runway-fill', type: 'fill', source: 'protomaps', 'source-layer': 'landuse', minzoom: 7,
        ...
        { id: 'boundaries-region', type: 'line', source: 'protomaps', 'source-layer': 'boundaries', minzoom: 3,
            filter: ['==', ['get', 'kind'], 'region'],
            paint: { 'line-color': c.regionBoundary, 'line-dasharray': [4, 3],
                'line-width': ['interpolate', ['linear'], ['zoom'], 3, 0.5, 6, 1, 10, 1.5],
                'line-opacity': c.regionBoundaryOpacity } },
        { id: 'runway-glow', type: 'line', source: 'protomaps', 'source-layer': 'roads', minzoom: 7,
            filter: ['==', ['get', 'kind_detail'], 'runway'],
            paint: { 'line-color': c.runwayGlow, 'line-opacity': 0.12,
                'line-width': ['interpolate', ['exponential', 1.6], ['zoom'], 7, 1.5, 9, 3, 12, 12] } },
        { id: 'runway', type: 'line', source: 'protomaps', 'source-layer': 'roads', minzoom: 7,
            filter: ['==', ['get', 'kind_detail'], 'runway'],
            paint: { 'line-color': c.runway,
                'line-width': ['interpolate', ['exponential', 1.6], ['zoom'], 6, 0.5, 8, 1.5, 12, 6] } },
        ...
        { id: 'roads', type: 'line', source: 'protomaps', 'source-layer': 'roads', minzoom: 5,
            ...
            paint: { 'line-color': c.roads, 'line-opacity': c.roadsOpacity, 'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 5, 0.4, 10, 1, 15, 3, 20, 8] } },
