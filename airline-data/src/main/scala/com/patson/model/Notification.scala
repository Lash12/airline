...
object NotificationCategory extends Enumeration {
   ...
   */
  val NEGOTIATION_LOSS, NEGOTIATION_READY, LEVEL_UP, LOYALIST, GAME_OVER, OLYMPICS_PRIZE, TUTORIAL, LINK_CANCELLATION, CASH_FLOW_WARNING, PROFIT_MILESTONE, MILESTONE_ACHIEVED, WORLD_NEWS, CONSULTANT_ADVICE, MARKET_OVERVIEW, AIRPORT_ASSET_COMPLETE = Value
}
