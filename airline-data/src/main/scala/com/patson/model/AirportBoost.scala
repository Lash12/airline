...
object AirportBoostType extends Enumeration {
  ...
  val POPULATION, INCOME, ELITE, INTERNATIONAL_HUB, ELITE_CHARM, VACATION_HUB, FINANCIAL_HUB, PRESTIGE_CHARM, CARGO = Value
  val getLabel = (boostType : AirportBoostType.Value) => boostType match {
    ...
    case PRESTIGE_CHARM => "Airline Prestige"
    case CARGO => "Cargo Throughput"
  }
}
