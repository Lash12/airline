...
object AirportAssetType {
  ...
  case object CARGO_TERMINAL    extends AirportAssetType("CARGO_TERMINAL", "Cargo Terminal", INFRASTRUCTURE, AirportBoostType.CARGO, 15, 180_000_000L, 16, 4, "CARGO_TERMINAL.png", "Raises cargo throughput at this airport, improving cargo carried on passenger and freight routes. No direct income.")
